    ...
    <div class="grid_9">
      <div class="grid_8">
        ...
        <?php if(isset($trans_id)): ?>
          <input type="hidden" name="id_trans" value="<?php echo $trans_id;?>">
          <div class="s_row_2 clearfix">
            <label>Nomor Transaksi:</label>
            <input type="text" size="30" value="<?php echo str_pad($trans_id, 7,"0",STR_PAD_LEFT);?>" disabled/>
          </div>
        <?php else: ?>
          <div class="s_row_2 clearfix">
            <label>Nomor Transaksi:</label>
        ...
        <?php endif;?>
          ...
          <span class="clear border_ddd"></span>
            <br />
          <button class="s_button_1 s_main_color_bgr" type="submit" onclick="kirim_konfirmasi();return false"><span class="s_text">Kirim</span></button>
        </form>
      </div>
    </div>
