    ...
    <?php else:?>
      ...
      <div id="listing_options">
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            <li id="view_grid" class="s_selected"><a href="#" onclick="change_view('grid')"><span class="s_icon"></span>Grid</a></li>
            <li id="view_list"><a href="#" onclick="change_view('list')"><span class="s_icon"></span>List</a></li>
          </ul>
        </div>
      </div>
